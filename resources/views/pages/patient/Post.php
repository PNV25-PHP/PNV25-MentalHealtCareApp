...
<div class="p-8 bg-gray-50 dark:bg-gray-900 flex items-center justify-center w-screen h-screen">
  <div class="px-5 py-4 bg-white dark:bg-gray-800 shadow rounded-lg max-w-lg">
    ...
    <div class="grid grid-rows-1 grid-cols-2">
      <img src="https://static-images.vnncdn.net/files/publish/2022/9/3/bi-kip-san-anh-dep-o-bien-vo-cuc-thai-binh-dang-hot-ran-ran-342.jpeg" alt="">
      <img src="https://static-images.vnncdn.net/files/publish/2022/9/3/bi-kip-san-anh-dep-o-bien-vo-cuc-thai-binh-dang-hot-ran-ran-342.jpeg" alt="">
    </div>
    <div class="flex justify-between items-center mt-5">
      <div class="flex ">
        ...
        <span class="ml-1 text-gray-500 dark:text-gray-400  font-light"> 0</span>
      </div>
